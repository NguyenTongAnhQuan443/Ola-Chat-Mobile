...
class _GroupManagementScreenState extends State<GroupManagementScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<GroupMembersRoleViewModel>(context, listen: false).fetchGroupMembers(widget.conversationId);
    });
  }
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: TextField(
                    ...
                    onSubmitted: (_) => _handleSave(context, _controller.text.trim(), vm),
                  ),
                ),
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: TextButton(
                        onPressed: () => _handleSave(context, _controller.text.trim(), vm),
                        child: Text(
                          "Lưu",
                          style: TextStyle(
                            fontSize: 16,
  ...
  Future<void> _handleSave(BuildContext context, String newName, GroupManagementViewModel vm) async {
  ...
  Future<void> _updateGroupName(BuildContext context, String newName, GroupManagementViewModel vm) async {
    if (newName.isEmpty) return;
  ...
  void _handleRename(BuildContext context, GroupManagementViewModel vm, TextEditingController controller) async {
