...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> handleAfterLoginSuccess() async {
    final loginVM = Provider.of<LoginViewModel>(context, listen: false);
    final auth = loginVM.authResponse;
    if (auth?.accessToken.isNotEmpty == true) {
      final socketVM = Provider.of<SocketViewModel>(context, listen: false);
      socketVM.initSocketConnection(auth!.accessToken);
    }
