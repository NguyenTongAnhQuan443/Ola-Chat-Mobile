...
//   void initState() {
//     super.initState();
//     // Lấy accessToken + userInfo từ TokenService
//     // Khởi tạo socket kết nối real-time bằng SocketService.
//     // Gọi init(conversationId) để load tin nhắn từ API/backend.
//     // _jumpToBottom() để cuộn đến tin nhắn cuối.
...
//       final vmConversation =
//           Provider.of<MessageConversationViewModel>(context, listen: false);
//       await vmConversation.init(widget.conversationId);
//       _jumpToBottom();
//     });
//   }
//
...
//                   color: Color(0xFF4C68D5)), // Voice call
//               tooltip: 'Gọi thoại',
//               onPressed: () {
//                 // TODO: Thực hiện gọi thoại
//                 ScaffoldMessenger.of(context).showSnackBar(
//                   const SnackBar(
//                       content: Text('Tính năng gọi thoại chưa khả dụng')),
//                 );
//               },
//             ),
//             IconButton(
//               icon: const Icon(Icons.videocam,
//                   color: Color(0xFF4C68D5)), // Video call
//               tooltip: 'Gọi video',
//               onPressed: () {
//                 Navigator.push(
//                   context,
