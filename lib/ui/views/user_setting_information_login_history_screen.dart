...
class UserSettingInformationLoginHistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final userId =
        Provider.of<LoginViewModel>(context, listen: false).userInfo?['userId'];
    ...
    return ChangeNotifierProvider(
      create: (_) =>
          UserSettingInformationLoginHistoryViewModel()..fetchHistory(userId),
              ...
              body: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SvgPicture.asset(
                      'assets/images/undraw_hello_ccwj.svg',
                      // đảm bảo có ảnh này
                      height: 180,
                    ),
                    const SizedBox(height: 12),
